...
Script to add index listings to a large number of files. User is
prompted for the text to index (case insensitive) and what to index it
with, e.g. projects!ASCL dirList is a list of all files to search in:
